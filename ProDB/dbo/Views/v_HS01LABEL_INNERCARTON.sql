...
*/
 CREATE   VIEW [dbo].[v_HS01LABEL_INNERCARTON] AS
SELECT 
    /* 基础信息字段 */
    e.Project,
    e.PO,
    ...
    /* 批次相关字段 */
    e.Carton_ID_Inner AS LOTID_WAFERID_BOXID,
    ...
    /* 复合标识字段 */
    b.Supplier_Code + '.' + e.Carton_ID_Inner AS [supplier_code.LOTID_WAFERID_BOXID],
    ...
    (b.Supplier_Code + '$' + 
     b.Material_PN + '$' + 
     (b.Supplier_Code + '.' + e.Carton_ID_Inner) + '$' + 
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[v_HS01LABEL_INNERCARTON] TO [Production1]
    AS [dbo];


GO
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[v_HS01LABEL_INNERCARTON] TO [Production]
    AS [dbo];
