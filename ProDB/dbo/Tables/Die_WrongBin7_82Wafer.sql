CREATE TABLE [dbo].[Die_WrongBin7_82Wafer] (
    ...
    [WrongBin7Cdt]          DATETIME     CONSTRAINT [DF_Die_WrongBin7_88Wafer_WrongBin7Cdt] DEFAULT (getdate()) NULL,
    [Bin_V3]                INT          NULL,
    [Shipped_Ship_date]     DATE         NULL,
    [Shipped_Customer_Code] VARCHAR (15) NULL,
    [Lot_Wafer_Box_ID]      VARCHAR (15) NULL,
    CONSTRAINT [PK_Die_WrongBin7_88Wafer] PRIMARY KEY CLUSTERED ([DieID] ASC)
);
